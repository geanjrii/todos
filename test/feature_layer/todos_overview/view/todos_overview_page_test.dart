      ...
      (tester) async {
        ...
        expect(
          find.descendant(
            ...
            matching: find.text("Flutter Todos"),
          ),
          findsOneWidget,
        );
      },
      ...
      (tester) async {
        ...
        expect(
          find.descendant(
            ...
            matching: find.text("An error occurred while loading todos."),
          ),
          findsOneWidget,
        );
      },
    ...
    group('when todos is empty', () {
      ...
      testWidgets(
        ...
        (tester) async {
          ...
          expect(find.text("No todos found with the selected filters."), findsOneWidget);
        },
      );
    });
